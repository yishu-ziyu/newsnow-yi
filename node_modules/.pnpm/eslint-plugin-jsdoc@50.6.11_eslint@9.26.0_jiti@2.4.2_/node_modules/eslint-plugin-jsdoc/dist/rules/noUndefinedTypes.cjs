...
var _default = exports.default = (0, _iterateJsdoc.default)(({
  ...
  const importTags = settings.mode === 'typescript' ? ( /** @type {string[]} */comments.flatMap(doc => {
    ...
    const importsExports = (0, _parseImportsExports.parseImportsExports)(imprt);
    const types = [];
    const namedImports = (_Object$values$ = Object.values(importsExports.namedImports || {})[0]) === null || _Object$values$ === void 0 ? void 0 : _Object$values$[0];
    if (namedImports) {
    ...
    const namespaceImports = (_Object$values$2 = Object.values(importsExports.namespaceImports || {})[0]) === null || _Object$values$2 === void 0 ? void 0 : _Object$values$2[0];
    if (namespaceImports) {
