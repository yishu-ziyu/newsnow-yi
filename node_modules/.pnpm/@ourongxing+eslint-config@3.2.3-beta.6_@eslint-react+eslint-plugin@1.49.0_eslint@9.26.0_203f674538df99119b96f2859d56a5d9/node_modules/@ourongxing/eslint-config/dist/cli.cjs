...
// package.json
var package_default = {
  name: "@ourongxing/eslint-config",
  type: "module",
  version: "3.2.3-beta.6",
  packageManager: "pnpm@9.11.0",
  description: "ourongxing's ESLint config",
  author: "Ou Rongxing <orongxing@gmail.com> (https://github.com/ourongxing/)",
  license: "MIT",
  homepage: "https://github.com/ourongxing/eslint-config",
  keywords: [
    "eslint-config"
  ],
  exports: {
  ...
  devDependencies: {
    ...
    "@ourongxing/eslint-config": "workspace:*",
    "@prettier/plugin-xml": "^3.4.1",
