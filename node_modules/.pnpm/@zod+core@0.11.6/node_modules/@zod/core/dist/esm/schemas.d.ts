...
export interface $ZodObjectInternals<out Shape extends Readonly<$ZodShape> = Readonly<$ZodShape>, out OutExtra extends Record<string, unknown> = Record<string, unknown>, out InExtra extends Record<string, unknown> = Record<string, unknown>> extends $ZodTypeInternals<any, any> {
...
type OptionalInSchema = {
    _zod: {
        optionality: "defaulted" | "optional";
    };
};
export type $InferObjectOutput<T extends $ZodLooseShape, Extra extends Record<string, unknown>> = string extends keyof T ? object : keyof T extends never ? Record<string, never> : util.Prettify<{
...
export type $InferObjectInput<T extends $ZodLooseShape, Extra extends Record<string, unknown>> = string extends keyof T ? object : keyof T extends never ? Record<string, never> : util.Prettify<{
...
export interface $ZodObject<out Shape extends Readonly<$ZodShape> = Readonly<$ZodShape>, out OutExtra extends Record<string, unknown> = Record<string, unknown>, out InExtra extends Record<string, unknown> = Record<string, unknown>> extends $ZodType {
...
export interface $ZodUnionInternals<T extends readonly $ZodType[] = readonly $ZodType[]> extends $ZodTypeInternals<$InferUnionOutput<T[number]>, $InferUnionOutput<T[number]>> {
    def: $ZodUnionDef<T>;
...
] ? Tail["_zod"]["optionality"] extends "optional" | "defaulted" ? [...TupleInputTypeWithOptionals<Prefix>, Tail["_zod"]["input"]?] : TupleInputTypeNoOptionals<T> : [];
...
type TupleOutputTypeWithOptionals<T extends util.TupleItems> = T extends readonly [
    ...infer Prefix extends $ZodType[],
    infer Tail extends $ZodType
] ? Tail["_zod"]["optionality"] extends "optional" ? [...TupleOutputTypeWithOptionals<Prefix>, core.output<Tail>?] : TupleOutputTypeNoOptionals<T> : [];
...
export interface $ZodCatchInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<core.output<T>, util.Loose<core.input<T>>> {
    def: $ZodCatchDef;
    optionality: T["_zod"]["optionality"];
    isst: never;
    values: T["_zod"]["values"];
