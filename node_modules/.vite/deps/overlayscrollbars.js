...
// node_modules/.pnpm/overlayscrollbars@2.11.2/node_modules/overlayscrollbars/overlayscrollbars.mjs
  ...
  [xt]: {
    static: () => ({
      R: (t2, n2, o2, s2, e2) => {
        ...
        const _hideNativeScrollbars = (t3, { B: o3 }, s3) => {
          if (!c2) {
            const e3 = assignDeep({}, {
              [y]: 0,
              [S]: 0,
        ...
        const _undoViewportArrange = () => {
          if (u2) {
            ...
            const { F: s3 } = n2;
            const { q: e3 } = _getViewportOverflowHideOffset(t3);
            const { x: c3, y: i3 } = e3;
            const l3 = {};
...
var createObserversSetup = (t2, n2, o2, s2) => {
  ...
  const { _t: p2, gt: g2, L: v2, vt: h2, ht: b2, V: w2, bt: y2, wt: S2, yt: m2, St: O2 } = t2;
  ...
  const onSizeChanged = ({ dt: t3, ft: n3 }) => {
    const o3 = t3 && !n3;
...
var createScrollbarsSetupElements = (t2, n2, o2, s2) => {
  ...
  const { slot: a2 } = l2;
  const { _t: u2, gt: f2, L: d2, At: _2, vt: g2, bt: v2, V: h2 } = n2;
  const { scrollbars: b2 } = _2 ? {} : t2;
  const { slot: w2 } = b2 || {};
  const y2 = [];
  const S2 = [];
  const m2 = [];
...
var createScrollbarsSetupEvents = (t2, n2, o2, s2) => (r2, i2, l2) => {
  const { gt: u2, L: f2, V: d2, vt: _2, Gt: p2, St: g2 } = n2;
  const { Lt: v2, Ut: h2, Mt: b2 } = r2;
...
var createScrollbarsSetup = (t2, n2, o2, s2, e2, c2) => {
  ...
  const { gt: $2, Kt: C2, bt: H2 } = e2;
  const { Ft: z2, Pt: I2, Nt: T2, qt: A2, Bt: D2 } = m2;
  ...
  return [() => bind(runEachAndClear, push(M2, O2())), ({ zt: t3, Tt: n3, Qt: e3, Zt: c3 }) => {
    const { tn: r3, nn: _3, sn: p3, en: g3 } = c3 || {};
    const { $t: v3, ft: h3 } = e3 || {};
    const { B: w3 } = o2;
    const { k: y3 } = getEnvironment();
    const { cn: S3, rn: m3 } = s2;
...
var createStructureSetupElements = (t2) => {
  ...
  const { padding: d2, viewport: _2, content: p2 } = f2 || {};
  ...
  const { _t: Y2, gt: W2, ln: J2, L: Q2, ht: nt2 } = X2;
  const ot2 = [() => {
    removeAttrs(W2, [B, P]);
    removeAttrs(Y2, P);
    if (v2) {
...
var createTrinsicUpdateSegment = ({ ht: t2 }) => ({ Qt: n2, fn: o2, Tt: s2 }) => {
  const { Ct: e2 } = n2 || {};
  const { Ot: c2 } = o2;
  const r2 = t2 && (e2 || s2);
  if (r2) {
...
var createPaddingUpdateSegment = ({ gt: t2, ln: n2, L: o2, V: s2 }, e2) => {
  const [c2, r2] = createCache({
    i: equalTRBL,
    o: topRightBottomLeft()
  }, bind(topRightBottomLeft, t2, "padding", ""));
  return ({ zt: t3, Qt: i2, fn: l2, Tt: a2 }) => {
    let [u2, f2] = r2(a2);
    const { U: d2 } = getEnvironment();
    const { dt: _2, xt: p2, $t: m2 } = i2 || {};
    const { B: O2 } = l2;
...
var createOverflowUpdateSegment = (t2, s2) => {
  ...
  const { gt: c2, ln: r2, L: i2, V: a2, Kt: u2, vt: f2, bt: d2, yt: _2, un: p2 } = t2;
  const { U: g2 } = e2;
  const v2 = d2 && a2;
  const h2 = bind(o, 0);
  const b2 = {
  ...
  return ({ zt: n2, Qt: o2, fn: l2, Tt: a3 }, { _n: u3 }) => {
    const { dt: f3, Ht: d3, xt: b3, $t: w3, ft: y3, Et: S3 } = o2 || {};
    ...
    if (gt2) {
      ...
      const { overflowX: t3, overflowY: n3 } = getStyles(i2, [m, O]);
      St2 = {
...
var createStructureSetup = (t2) => {
  ...
  const { _t: c2, vt: r2, V: i2, St: l2 } = n2;
...
var createSetups = (t2, n2, o2, s2, e2) => {
  ...
  const update = (t3, e3) => {
    ...
    const { gn: r3, Tt: i3, It: a3, vn: u3 } = t3;
    const f3 = r3 || {};
    const d3 = !!i3 || !c2;
    const g3 = {
...
var OverlayScrollbars = (t2, n2, o2) => {
  ...
  if (n2 && !r2) {
    ...
    const [v2, h2, b2, w2, y2] = createSetups(t2, a2, () => r3, ({ gn: t3, Tt: n3 }, { Qt: o3, Zt: s3 }) => {
      const { dt: e3, $t: c3, Ct: r4, xt: i3, Ht: l3, ft: a3 } = o3;
      const { tn: u3, nn: f3, sn: d3, en: _3 } = s3;
    ...
    const S2 = {
      ...
      state() {
        ...
        const { B: o3 } = t3;
        const { Vt: s3, Rt: e3, cn: c3, rn: i3, ln: l3, dn: a3, Dt: u3 } = n3;
        return assignDeep({}, {
          overflowEdge: s3,
          overflowAmount: e3,
          overflowStyle: c3,
      ...
      elements() {
        const { _t: t3, gt: n3, ln: o3, L: s3, ht: e3, vt: c3, Kt: r4 } = w2.wn;
        const { jt: i3, Jt: l3 } = w2.yn;
